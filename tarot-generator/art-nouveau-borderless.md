# 🔮 Tarot Card Prompts - Art Nouveau Ethereal (無邊框版)

> 這些 prompts 可直接複製貼到 [gemini.google.com](https://gemini.google.com/app) 使用

**風格**: Art Nouveau Ethereal
**描述**: 新藝術運動風格，慕夏的優雅曲線
**牌數**: 22 張 + 牌背
**模式**: 🖼️ 無邊框 (Photoshop合成用)
...
```
BORDERLESS TAROT CARD ILLUSTRATION - NO FRAME

Stunning Art Nouveau tarot card illustration.
...
CRITICAL: This is for Photoshop compositing - generate ONLY the illustration with NO border or frame.
...
COLOR PALETTE:
Sage green, dusty rose, gold, cream, soft lavender
...
- The title "The Fool" can be subtly integrated INTO the illustration (not in a title plate)
- This will be composited with a separate frame later in Photoshop
```
...
- High resolution, commercial quality illustration
- Vertical 9:16 aspect ratio
- The title "The Magician" can be subtly integrated INTO the illustration (not in a title plate)
- This will be composited with a separate frame later in Photoshop
```
...
- High resolution, commercial quality illustration
- Vertical 9:16 aspect ratio
- The title "The High Priestess" can be subtly integrated INTO the illustration (not in a title plate)
- This will be composited with a separate frame later in Photoshop
```
...
- High resolution, commercial quality illustration
- Vertical 9:16 aspect ratio
- The title "The Empress" can be subtly integrated INTO the illustration (not in a title plate)
- This will be composited with a separate frame later in Photoshop
```
...
- High resolution, commercial quality illustration
- Vertical 9:16 aspect ratio
- The title "The Emperor" can be subtly integrated INTO the illustration (not in a title plate)
- This will be composited with a separate frame later in Photoshop
```
...
- High resolution, commercial quality illustration
- Vertical 9:16 aspect ratio
- The title "The Hierophant" can be subtly integrated INTO the illustration (not in a title plate)
- This will be composited with a separate frame later in Photoshop
```
...
- High resolution, commercial quality illustration
- Vertical 9:16 aspect ratio
- The title "The Lovers" can be subtly integrated INTO the illustration (not in a title plate)
- This will be composited with a separate frame later in Photoshop
```
...
- High resolution, commercial quality illustration
- Vertical 9:16 aspect ratio
- The title "The Chariot" can be subtly integrated INTO the illustration (not in a title plate)
- This will be composited with a separate frame later in Photoshop
```
...
- High resolution, commercial quality illustration
- Vertical 9:16 aspect ratio
- The title "Strength" can be subtly integrated INTO the illustration (not in a title plate)
- This will be composited with a separate frame later in Photoshop
```
...
- High resolution, commercial quality illustration
- Vertical 9:16 aspect ratio
- The title "The Hermit" can be subtly integrated INTO the illustration (not in a title plate)
- This will be composited with a separate frame later in Photoshop
```
...
- High resolution, commercial quality illustration
- Vertical 9:16 aspect ratio
- The title "Wheel of Fortune" can be subtly integrated INTO the illustration (not in a title plate)
- This will be composited with a separate frame later in Photoshop
```
...
- High resolution, commercial quality illustration
- Vertical 9:16 aspect ratio
- The title "Justice" can be subtly integrated INTO the illustration (not in a title plate)
- This will be composited with a separate frame later in Photoshop
```
...
- High resolution, commercial quality illustration
- Vertical 9:16 aspect ratio
- The title "The Hanged Man" can be subtly integrated INTO the illustration (not in a title plate)
- This will be composited with a separate frame later in Photoshop
```
...
- High resolution, commercial quality illustration
- Vertical 9:16 aspect ratio
- The title "Death" can be subtly integrated INTO the illustration (not in a title plate)
- This will be composited with a separate frame later in Photoshop
```
...
- High resolution, commercial quality illustration
- Vertical 9:16 aspect ratio
- The title "Temperance" can be subtly integrated INTO the illustration (not in a title plate)
- This will be composited with a separate frame later in Photoshop
```
...
- High resolution, commercial quality illustration
- Vertical 9:16 aspect ratio
- The title "The Devil" can be subtly integrated INTO the illustration (not in a title plate)
- This will be composited with a separate frame later in Photoshop
```
...
- High resolution, commercial quality illustration
- Vertical 9:16 aspect ratio
- The title "The Tower" can be subtly integrated INTO the illustration (not in a title plate)
- This will be composited with a separate frame later in Photoshop
```
...
- High resolution, commercial quality illustration
- Vertical 9:16 aspect ratio
- The title "The Star" can be subtly integrated INTO the illustration (not in a title plate)
- This will be composited with a separate frame later in Photoshop
```
...
- High resolution, commercial quality illustration
- Vertical 9:16 aspect ratio
- The title "The Moon" can be subtly integrated INTO the illustration (not in a title plate)
- This will be composited with a separate frame later in Photoshop
```
...
- High resolution, commercial quality illustration
- Vertical 9:16 aspect ratio
- The title "The Sun" can be subtly integrated INTO the illustration (not in a title plate)
- This will be composited with a separate frame later in Photoshop
```
...
- High resolution, commercial quality illustration
- Vertical 9:16 aspect ratio
- The title "Judgement" can be subtly integrated INTO the illustration (not in a title plate)
- This will be composited with a separate frame later in Photoshop
```
...
- High resolution, commercial quality illustration
- Vertical 9:16 aspect ratio
- The title "The World" can be subtly integrated INTO the illustration (not in a title plate)
- This will be composited with a separate frame later in Photoshop
```
