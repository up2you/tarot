...
Dreamy watercolor tarot card illustration.
...
COLOR PALETTE:
Soft blush, dusty blue, sage, lavender, gold foil
...
Dreamy watercolor tarot card back design.
      Soft transparent color washes with beautiful bleeding edges.
      Perfectly symmetrical flowing organic pattern design.
      Organic flowing shapes and gentle gradients.
      Ethereal atmosphere with white space breathing room.
      Delicate gold foil accents on symmetrical key elements.
      Romantic and whimsical mood throughout pattern.
      High-end wedding invitation aesthetic.
      Premium fine art watercolor quality.
      Vertical composition 9:16 aspect ratio.
...
VISUAL COMPOSITION:
Ornate symmetrical design with central blooming watercolor mandala.
      Soft pigment washes and organic shapes radiating outward.
      Four corner elements with delicate floral and crystal motifs.
      Layered transparent washes creating ethereal depth.
      Hidden soft symbolic elements woven into flowing patterns.
      Gentle warm glow emanating from romantic center.

ARTISTIC MOOD:
Romantic, ethereal, gentle, dreamlike serenity

STYLE: Watercolor Dreams
COLOR PALETTE: Soft blush, dusty blue, sage, lavender, gold foil
ARTISTIC INFLUENCE: Agnes Cecile, modern watercolor artists, wedding stationery
