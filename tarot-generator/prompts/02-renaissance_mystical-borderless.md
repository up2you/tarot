# 🔮 Tarot Card Prompts - Renaissance Mystical (無邊框版)

> 這些 prompts 可直接複製貼到 [gemini.google.com](https://gemini.google.com/app) 使用

**風格**: Renaissance Mystical
**描述**: 文藝復興時期神秘主義風格，波提切利柔美線條
**牌數**: 22 張 + 牌背
...
Exquisite tarot card in Italian Renaissance style.
...
COLOR PALETTE:
Ultramarine blue, vermillion, gold leaf, earth tones, soft ivory
