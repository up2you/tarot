# 🔮 Tarot Card Prompts - Stained Glass Cathedral (無邊框版)

> 這些 prompts 可直接複製貼到 [gemini.google.com](https://gemini.google.com/app) 使用

**風格**: Stained Glass Cathedral
**描述**: 教堂彩色玻璃風格，哥特式光線
**牌數**: 22 張 + 牌背
...
Magnificent stained glass tarot card illustration.
...
COLOR PALETTE:
Sapphire blue, ruby red, emerald green, amber, purple
