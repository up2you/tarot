...
-- 7. 插入預設風格（32 種）
INSERT INTO card_styles (style_key, name_zh, name_en, category, price, is_free, is_featured, sort_order) VALUES
    -- 免費風格（3 種）
    ('classic', '經典萊德', 'Classic Rider-Waite', 'classic', 0, true, false, 1),
    ('minimalist', '極簡風格', 'Minimalist', 'modern', 0, true, false, 2),
    ('watercolor', '水彩柔美', 'Watercolor', 'artistic', 0, true, false, 3),
    
    -- 經典類（5 種）
    ('vintage', '復古典藏', 'Vintage Collection', 'classic', 99, false, false, 10),
    ('golden', '金箔奢華', 'Golden Luxe', 'classic', 149, false, true, 11),
    ('medieval', '中世紀古風', 'Medieval', 'classic', 99, false, false, 12),
    ('renaissance', '文藝復興', 'Renaissance', 'classic', 129, false, false, 13),
    ('baroque', '巴洛克華麗', 'Baroque', 'classic', 149, false, false, 14),
    
    -- 現代類（6 種）
    ('neon', '霓虹都市', 'Neon City', 'modern', 99, false, false, 20),
    ('cyberpunk', '賽博龐克', 'Cyberpunk', 'modern', 129, false, true, 21),
    ('geometric', '幾何抽象', 'Geometric', 'modern', 79, false, false, 22),
    ('glitch', '故障藝術', 'Glitch Art', 'modern', 99, false, true, 23),
    ('vaporwave', '蒸汽波', 'Vaporwave', 'modern', 99, false, false, 24),
    ('synthwave', '合成波', 'Synthwave', 'modern', 99, false, false, 25),
    
    -- 奇幻類（6 種）
    ('celestial', '星空神秘', 'Celestial', 'fantasy', 129, false, true, 30),
    ('fairy', '精靈仙境', 'Fairy Realm', 'fantasy', 99, false, false, 31),
    ('dragon', '龍族傳說', 'Dragon Legend', 'fantasy', 149, false, false, 32),
    ('witch', '魔女月光', 'Witch Moon', 'fantasy', 99, false, true, 33),
    ('crystal', '水晶魔法', 'Crystal Magic', 'fantasy', 109, false, false, 34),
    ('gothic', '哥德暗黑', 'Gothic Dark', 'fantasy', 129, false, false, 35),
    
    -- 文化類（6 種）
    ('japanese', '和風浮世繪', 'Japanese Ukiyo-e', 'cultural', 149, false, true, 40),
    ('chinese', '東方水墨', 'Chinese Ink', 'cultural', 149, false, false, 41),
    ('egyptian', '埃及神秘', 'Egyptian Mystery', 'cultural', 129, false, false, 42),
    ('celtic', '凱爾特結', 'Celtic Knot', 'cultural', 99, false, false, 43),
    ('indian', '印度曼陀羅', 'Indian Mandala', 'cultural', 129, false, false, 44),
    ('nordic', '北歐符文', 'Nordic Rune', 'cultural', 129, false, false, 45),
    
    -- 藝術類（6 種）
    ('oil_painting', '油畫質感', 'Oil Painting', 'artistic', 149, false, false, 50),
    ('stained_glass', '彩繪玻璃', 'Stained Glass', 'artistic', 129, false, true, 51),
    ('art_nouveau', '新藝術風', 'Art Nouveau', 'artistic', 149, false, false, 52),
    ('impressionist', '印象派', 'Impressionist', 'artistic', 129, false, false, 53),
    ('line_art', '線條藝術', 'Line Art', 'artistic', 79, false, false, 54),
    ('pop_art', '普普藝術', 'Pop Art', 'artistic', 99, false, false, 55)
